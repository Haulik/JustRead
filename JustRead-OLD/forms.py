...
from JustRead3.queries import get_user_by_user_name, get_farmer_by_pk, get_customer_by_pk
from JustRead3.utils.choices import ProduceItemChoices, ProduceCategoryChoices, UserTypeChoices, \
